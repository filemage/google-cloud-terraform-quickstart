...
CREATE USER filemage WITH PASSWORD '${pg_password}';
CREATE DATABASE filemage OWNER filemage;
EOL
...
echo "pg_partman_bgw.role = 'filemage'" >> /etc/postgresql/12/main/postgresql.conf
